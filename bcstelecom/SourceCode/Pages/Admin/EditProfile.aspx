<%@ Page Title="Edit Profile" Language="C#" MasterPageFile="~/MasterPages/Admin.master"
    ValidateRequest="false" AutoEventWireup="true" CodeFile="EditProfile.aspx.cs"
    Inherits="Pages_Admin_EditProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
    <asp:UpdatePanel runat="server" UpdateMode="Conditional">
        ...
        <%--function ShowHideDegree() {
            var ddlDegree = document.getElementById("ctl00_cpnhMain_ddlDegree");

            var tbxOther = document.getElementById("ctl00_cpnhMain_tbxOther");

            if (ddlDegree.options[ddlDegree.selectedIndex].value == "Other") {
                tbxOther.style.visibility = "visible";
                ValidatorEnable(document.getElementById('<%=reqDegree.ClientID%>'), true);
            }
            else {
                tbxOther.style.visibility = "hidden";
                ValidatorEnable(document.getElementById('<%=reqDegree.ClientID%>'), false);
            }
        }--%>
        $(document).ready(function () {
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="tbxUserName" runat="server" Enabled="False" ReadOnly="True" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3">
                        ...
                        <asp:UpdatePanel runat="server" ID="pnlChild">
                            <ContentTemplate>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <asp:GridView ID="gvChild" runat="server" AllowPaging="false" Width="100%" AutoGenerateColumns="False">
                                                <Columns>
                            ...
                            <ContentTemplate>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="tbxInstitute" runat="server" Width="150px"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="tbxPassingYear" runat="server" Width="70px"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="tbxSubject" runat="server" Width="100px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="tbxOther" runat="server" Width="170px"></asp:TextBox>
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <asp:GridView ID="gvEducation" runat="server" AllowPaging="false" Width="100%" AutoGenerateColumns="False">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Ser">
                                                        <ItemTemplate>
                                                            <%# Container.DataItemIndex + 1 %>
                        ...
                        <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                            <ContentTemplate>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="tbxDesignation" runat="server" Width="150px"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="tbxNameOftheOffice" runat="server" Width="150px"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="tbxDateofJoining" runat="server" Width="100px"></asp:TextBox>
            ...
            <div class="row">
                <div class="col-md-9 ">
                    ...
                    <asp:Button CssClass="btn btn-primary" ID="hlkBack" Text="Back" runat="server" CausesValidation="false"
                        PostBackUrl="~/Pages/Admin/UserAdministration.aspx" />
                </div>
            </div>
            <triggers>
